...
class AlienInvasion:
    ...
    def _start_game(self):
            ...
            self.sb.prep_score() # 0 score start
            self.sb.prep_level() #1 level start
            self.sb.prep_ships()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            #Destroying existing bullets and create a new fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _fire_bullet(self):
        ...
        if(len(self.bullets) < self.settings.bullets_allowed): #fixed no of bullets allowed
